// Código anterior e que esta funcionando com Falhas ao Atualizar página
...
//   const { nome, nivel, email, perfil_imagem } = session.usuario;
//   const [perfilImagem, setPerfilImagem] = useState(perfil_imagem || "/img/avatar.jpg"); // Usa a imagem da sessão ou um padrão

//   const handleImageChange = async (novaImagem: string) => {
//     setPerfilImagem(novaImagem); // Atualiza a imagem no estado
//     await update({ usuario: { ...session.usuario, perfil_imagem: novaImagem } }); // Atualiza a sessão
//   };
