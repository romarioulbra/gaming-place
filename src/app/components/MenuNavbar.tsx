...
// export default function Navbar() {
//   // Usando o hook useSession para acessar a sessão do usuário
//   const { data: session } = useSession(); 
//   const nivelUsuario = session ? session.user?.role || 'Normal' || 'Administrador': ''; // Determinando o nível de usuário
//   const [isOpen, setIsOpen] = useState(false);
//   const pathname = usePathname();
...
//           { label: "Jogos", path: "/jogos/categorias" },
//           { label: "Conta", path: "/conta" },
//           { label: "Perfil", path: "/dashboard/usuario_login" }, // Exibe o link "Perfil" se o usuário estiver logado
//         ];
//       default:
//         return [
//           { label: "Ínício", path: "/" },
