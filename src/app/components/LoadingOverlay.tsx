  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-purple-900 via-black to-gray-900 bg-opacity-90 z-50 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        {/* <div className="w-2 h-2 bg-purple-500 rounded-full animate-ping absolute top-1/4 left-1/4"></div>
        <div className="w-3 h-3 bg-pink-500 rounded-full animate-pulse absolute bottom-1/4 right-1/4"></div> */}
