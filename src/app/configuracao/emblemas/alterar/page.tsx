...
import AlterarEmblemas from "./AlterarEmblemas";
...
// // Defina o tipo esperado para 'dados' se souber a estrutura
// interface EmblemaData {
//   emblema_id: number;
//   emblema_nome: string;
...
// interface AlterarEmblemasProps {
//   dados: EmblemaData;
// }
...
// export default function AlterarEmblemas({ dados }: AlterarEmblemasProps) {
//   const [formData, setFormData] = useState<EmblemaData>(dados); // Inicializa com os dados recebidos
//   const [modalText, setModalText] = useState(""); // Texto do modal
//   const [loading, setLoading] = useState(false); // Estado para controlar o loading
//   const [file, setFile] = useState<File | null>(null); // Estado para o arquivo
...
//   // Atualiza o estado ao editar os inputs
//   const handleInputChange = (field: keyof EmblemaData, value: string | number) => {
//     setFormData((prev) => ({
//       ...prev,
//       [field]: value,
//     }));
...
//       setFormData((prev) => ({
//         ...prev,
//         emblema_imagem: selectedFile.name, // Opcional: só pra atualizar a string no formData
//       }));
//     }
//   };

//   // Função para buscar categorias dos Emblemas (removi pois não está sendo usado)
//   /*
//   useEffect(() => {
//     const fetchEmblemas = async () => {
//       try {
...
//       formDados.append("emblema_nome", formData.emblema_nome);
//       formDados.append("emblema_criterio", formData.emblema_criterio);
//       formDados.append("emblemas_pontos", String(formData.emblemas_pontos));
//       formDados.append("emblemas_status", formData.emblemas_status);
...
//       console.log("FormData enviado:");
//       for (const [key, value] of formDados.entries()) {
//         console.log(`${key}:`, value);
//       }
...
//           idFileInput="emblema_imagem"
//           metodoSubmit={(e) =>
//             setFormData({ ...formData, emblema_imagem: e.target.files ? e.target.files[0].name : "" })
//           }
//           onChange={(e) => handleInputChange("emblema_imagem", e.target.files ? e.target.files[0].name : "")}
//         />
...
export default function Page() {
  return <div>Esta é a página de alteração de emblemas.</div>;
}