...
export default function CardJogo({ title, image, buttonText }) {
  return (
     <>
      <div className="bg-purple-600 rounded-lg p-6 ml-16 grid justify-items-center shadow-lg shadow-slate-300 rotate-2 hover:scale-105 transition-transform duration-300">
