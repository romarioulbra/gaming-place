...
// import { useState, useEffect } from "react";
// import { FaGamepad } from "react-icons/fa"; // Ícone de game
// import Image from "next/image";
// import Link from "next/link";
// import axios from "axios";
...
//     }, 1000); // Tempo de simulação de carregamento (ajuste conforme necessário)
//   };
...
//         <div className="w-full h-[600px] bg-white shadow-lg shadow-slate-500 overflow-hidden flex border-white border-4 mx-4">
//           <ul className="list-none p-0 m-0 w-1/3 bg-gray-300 flex flex-col border-r h-full overflow-y-auto custom-scroll">
//             {filteredJogos.map((game) => (
//               <li
//                 key={game.id}
...
//                   <FaGamepad className="text-5xl text-purple-800 animate-spin mb-4" />
