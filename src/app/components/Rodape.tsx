...
export default function Footer() {
  return (
      <footer className="flex flex-col items-center justify-between p-4 bg-gray-900 text-gray-200 py-4 border-t-2 border-white">
      {/* /  <footer className="flex flex-col items-center justify-between p-4 bg-fuchsia-500 text-gray-200 py-4 border-t-2 border-white"> */}
