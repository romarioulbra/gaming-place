...
//       const pontosAcumulativosAtuais = emblemaUsuario.usuario_emblemas_pontos_acumulativo;
//       const novosPontosAcumulativos = pontosAcumulativosAtuais + pontosAtuais;

//       // 2. Atualiza o emblema do usuário
...
//       // 3. Atualiza o perfil (adiciona pontos)
...
//       // 4. Verifica se deve aumentar o nível
//       const deveAumentarNivel = novosPontosAcumulativos >= emblemaBase.emblemas_pontos;
      
//       if (deveAumentarNivel) {
//         // Calcula quantos níveis devem ser aumentados (caso tenha passado muito dos pontos necessários)
...
//         nivelAumentado: deveAumentarNivel
//       };
//     });
