...
//   const salvarSenha = () => {
//     // Aqui você pode fazer a lógica de salvar a senha (por exemplo, uma requisição para o servidor)
//     console.log('Senha alterada para:', senha);
//     fecharModal(); // Fecha o modal após salvar a senha
//   };
